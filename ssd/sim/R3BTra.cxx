...
R3BTra::R3BTra(const TString& geoFile, const TGeoCombiTrans& combi)
    : R3BDetector("R3BTra", kTRA, geoFile, combi), fTraCollection(new TClonesArray("R3BTraPoint")), fPosIndex(0),
      kGeoSaved(kFALSE), flGeoPar(new TList()), fNbDet(20)
{
