...
R3BCDGenerator::R3BCDGenerator() : px1(0.), py1(0.), pz1(0.), E1(0.), px2(0.), py2(0.), pz2(0.), E2(0.), inputFile(NULL)
{
    //
    // Constructor
    //
...
R3BCDGenerator::R3BCDGenerator(const R3BCDGenerator& right)
    : px1(right.px1), py1(right.py1), pz1(right.pz1), E1(right.E1), px2(right.px2), py2(right.py2), pz2(right.pz2),
      E2(right.E2), inputFile(right.inputFile)
{
}
