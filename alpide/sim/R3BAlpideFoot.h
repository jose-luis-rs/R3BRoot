...
// ---------------------------------------------------------------
// -----                    R3BAlpideFoot                    -----
// -----          Created 12/09/2026 by J.L. Rodriguez       -----
// ---------------------------------------------------------------
...
class R3BAlpideFoot : public R3BDetector
{
  public:
    /** Default constructor **/
    R3BAlpideFoot();
     ...
     *@param rot     rotation
     */
    R3BAlpideFoot(const TString& geoFile, const TGeoTranslation& trans, const TGeoRotation& rot = TGeoRotation());

    /** Standard constructor.
     *@param geoFile name of the ROOT geometry file
     *@param combi   position + rotation
     */
    R3BAlpideFoot(const TString& geoFile, const TGeoCombiTrans& combi = TGeoCombiTrans());

    /** Destructor **/
    ~R3BAlpideFoot() override;
  ...
  private:
    ...
    TClonesArray* fAlpidePoint;     //  Alpide data
    TClonesArray* fFootPoint;       //  Foot data
  ...
  public:
    ClassDefOverride(R3BAlpideFoot, 1);
};

inline void R3BAlpideFoot::ResetParameters()
{
