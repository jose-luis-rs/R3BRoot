...
R3BOnlineSpectraLosVsSci2::R3BOnlineSpectraLosVsSci2() : R3BOnlineSpectraLosVsSci2("R3BOnlineSpectraLosVsSci2", 1) {}
...
R3BOnlineSpectraLosVsSci2::R3BOnlineSpectraLosVsSci2(const char* name, Int_t iVerbose)
    : FairTask(name, iVerbose), fTrigger(-1), fTpat(-1), fClockFreq(5.), fNEvents(0), fTcalSci2(NULL),
      ...
      //, fFrsDataCA(NULL)
      ,
      fToFoffset(0), fToFmin(-5000), fToFmax(5000), fTof2InvV_p0(-7.8), fTof2InvV_p1(0.0073), fL2(137), fPos_p0(-11),
      fPos_p1(54.7), fDispersionS2(7000.), fBrho0_S2toCC(9.458), fP0(-2.12371e7), fP1(4.9473e7), fP2(-2.87635e7),
      fZprimary(50.), fZoffset(-1.3), ZMUSIC_cut(50), ZMUSIC_wcut(0.5), fOnline(kFALSE)
{
}
