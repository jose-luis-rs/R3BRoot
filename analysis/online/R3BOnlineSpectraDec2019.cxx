...
R3BOnlineSpectraDec2019::R3BOnlineSpectraDec2019() : R3BOnlineSpectraDec2019("OnlineSpectra", 1) {}

R3BOnlineSpectraDec2019::R3BOnlineSpectraDec2019(const char* name, Int_t iVerbose)
    : FairTask(name, iVerbose), fTrigger(-1), fTpat(-1), fSamp(-1), fNofPlanes(N_PLANE_MAX_TOFD),
      fPaddlesPerPlane(N_PADDLE_MAX_TOFD), fClockFreq(1. / VFTX_CLOCK_MHZ * 1000.), fNEvents(0)
{
}
