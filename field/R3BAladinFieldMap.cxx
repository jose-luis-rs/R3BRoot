...
R3BAladinFieldMap::R3BAladinFieldMap() : fBx(NULL), fBy(NULL), fBz(NULL) { fType = 1; }

R3BAladinFieldMap::R3BAladinFieldMap(const char* mapName, const char* fileType)
    : FairField(mapName), fBx(NULL), fBy(NULL), fBz(NULL)
{
    fType = 1;
}

R3BAladinFieldMap::R3BAladinFieldMap(R3BFieldPar* fieldPar) : fBx(NULL), fBy(NULL), fBz(NULL)
{
    fType = 1;
