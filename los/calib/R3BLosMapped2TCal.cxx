...
R3BLosMapped2TCal::R3BLosMapped2TCal() : R3BLosMapped2TCal("R3BLosMapped2TCal", 1) {}
...
R3BLosMapped2TCal::R3BLosMapped2TCal(const char* name, Int_t iVerbose)
    : FairTask(name, iVerbose), fMappedItems(NULL), fMappedTriggerItems(NULL),
      fTCalItems(new TClonesArray("R3BLosTCalData")), fTCalTriggerItems(new TClonesArray("R3BLosTCalData")),
      fNofTCalItems(0), fNofTcalPars(0), fTcalPar(NULL),
